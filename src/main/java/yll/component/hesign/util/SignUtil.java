...
public class SignUtil {
    ...
    public static String signature(TreeMap<String ,Object> map, String uuid, String appSecret){
        return SHA1.encode(httpBuildQuery(map,"UTF-8") + "&nonce=" + uuid + "&appSecret=" + appSecret);
    }

    private static String httpBuildQuery(Map<String, Object> params, String encoding  ) {
        if (isEmpty(encoding)) {
            encoding = "UTF-8";
        }
